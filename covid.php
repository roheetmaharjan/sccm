...
<div class="inner-page">
    ...
    <!-- Description -->
    <section class="section-padding light-grey about-content">
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-6 m-auto">
                    <p><b>The health and wellbeing of our students, staff and visitors is our priority, and this has been one of our focuses throughout 2020.</b></p>
                    <p>At SCCM, we follow the NSW Health and the government's guidelines for handling COVID-19. We encourage all students, staff and visitors to keep abreast of the latest news about COVID-19 on <a href="#">www.health.nsw.gov.au.</a> </p>
                </div>
                <div class="col-sm-12 col-md-6 ml-auto">
                    <figure><img src="./assets/img/course.png" alt=""></figure>
                </div>
            </div>
        </div>
    </section>

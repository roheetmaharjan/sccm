...
<div class="inner-page">
    ...
    <section class="section-padding light-grey">
        <div class="container">
            <div class="row company-location light-green-bg">
                <div class="col-sm-12 col-md-5">
                    <div class="company-location-detail">
                        <h4 class="company-location-title">Parramatta Campus</h4>
            ...
            <div class="row company-location light-green-bg">
                <div class="col-sm-12 col-md-5">
                    <div class="company-location-detail">
                        <h4 class="company-location-title">Sydney Campus</h4>
                        <h5 class="company-location-sub-title">Level 2, 17 Macquarie Street, Parramatta, NSW 2150</h5>
            ...
            <div class="row company-location light-green-bg">
                <div class="col-sm-12 col-md-5">
                    <div class="company-location-detail">
                        <h4 class="company-location-title">Darwin Campus</h4>
                        <h5 class="company-location-sub-title">Level 2, 17 Macquarie Street, Parramatta, NSW 2150</h5>

<div class="application-form-title">
    <h3 class="text-green"><b>Application Summary</b></h3>
    <p class="form-sub-title"><small>Application No. 1021 created on: 18/03/2021 4:27:44 PM Status Awaiting Agent Approval</small></p>
</div>
<h6 class="mb-4">Applicant Details</h6>
<div class="white-box bg-white p-4 mb-2">
    <div class="row">
...
<br>
<h6 class="mb-4">Selected Course</h6>
<div class="white-box bg-white p-4 mb-2">
    <div class="row">
        <div class="col-sm-6 col-md-4">
